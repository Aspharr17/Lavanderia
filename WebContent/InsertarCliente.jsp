	...
	<div class="d-flex" >	
		<div class="card col-sm-4" >
			...
			<c:forEach var="cliente" items ="${clienteBuscado}">
				...
				<a class="btn btn-danger" href="eliminarCliente.do?id_cl=${cliente.getId_cl()}">Eliminar</a>
				<a class="btn btn-warning" href="paginaeditarCliente.do?id_cl=${cliente.getId_cl()}
				&nom_cl=${cliente.getNom_cl()}&ape_cl=${cliente.getApe_cl()}&tel_cl=${cliente.getTel_cl()}">Editar</a>
			</c:forEach>	
